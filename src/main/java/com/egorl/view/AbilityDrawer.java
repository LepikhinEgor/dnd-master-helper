...
import com.egorl.model.CharacterAbility;
...
public class AbilityDrawer extends JPanel {

    private final int ICON_SIZE = 45;

    private static final Logger logger = LoggerFactory.getLogger(AbilityDrawer.class);
    ...
    public AbilityDrawer(CharacterAbility ability) {
